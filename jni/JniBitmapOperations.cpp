...
extern "C" {
//store
JNIEXPORT jobject JNICALL Java_com_comic_lazyupload_camera_JniBitmapHolder_jniStoreBitmapData(
		JNIEnv * env, jobject obj, jobject bitmap);
//get
JNIEXPORT jobject JNICALL Java_com_comic_lazyupload_camera_JniBitmapHolder_jniGetBitmapFromStoredBitmapData(
		JNIEnv * env, jobject obj, jobject handle);
//free
JNIEXPORT void JNICALL Java_com_comic_lazyupload_camera_JniBitmapHolder_jniFreeBitmapData(
		JNIEnv * env, jobject obj, jobject handle);
//rotate 90 degrees CCW
JNIEXPORT void JNICALL Java_com_comic_lazyupload_camera_JniBitmapHolder_jniRotateBitmapCcw90(
		JNIEnv * env, jobject obj, jobject handle);
//rotate 90 degrees CW
JNIEXPORT void JNICALL Java_com_comic_lazyupload_camera_JniBitmapHolder_jniRotateBitmapCw90(
		JNIEnv * env, jobject obj, jobject handle);
//crop
JNIEXPORT void JNICALL Java_com_comic_lazyupload_camera_JniBitmapHolder_jniCropBitmap(
		JNIEnv * env, jobject obj, jobject handle, uint32_t left, uint32_t top,
		uint32_t right, uint32_t bottom);
//scale using nearest neighbor
JNIEXPORT void JNICALL Java_com_comic_lazyupload_camera_JniBitmapHolder_jniScaleNNBitmap(
...
JNIEXPORT void JNICALL Java_com_comic_lazyupload_camera_JniBitmapHolder_jniRotateBitmapCcw90(
	...
	uint32_t* newBitmapPixels = new uint32_t[bitmapInfo.height
			* bitmapInfo.width];
	int whereToGet = 0;
	// XY. ... ... ..X
	// ...>Y..>...>..Y
