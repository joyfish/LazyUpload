package com.comic.lazyupload.utils;
	...
	public static String getAccessToken(Context context) {
		...
		if (acctoken == null || acctoken.isEmpty()) {
			...
			if (code != null && !code.isEmpty()) {
				acctoken = NetUtils.reissueAccessToken(
