...
import com.comic.lazyupload.upload.UploadRunnable.TaskRunnableUploadMethods;
	...
	public void handleDownloadState(int state) {
		...
		case UploadRunnable.HTTP_STATE_COMPLETED:
			Message completeMessage = mHandler.obtainMessage(
					UploadRunnable.HTTP_STATE_COMPLETED, this);
			completeMessage.sendToTarget();
			break;
		case UploadRunnable.HTTP_STATE_FAILED:
			Message errorMessage = mHandler.obtainMessage(
					UploadRunnable.HTTP_STATE_FAILED, this);
			errorMessage.sendToTarget();
			break;
		case UploadRunnable.TOKEN_ERROR:
			Message tokenErrorMessage = mHandler.obtainMessage(
					UploadRunnable.TOKEN_ERROR, this);
