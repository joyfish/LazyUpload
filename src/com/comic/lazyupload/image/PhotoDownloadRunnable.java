...
import com.comic.lazyupload.image.PhotoDecodeRunnable.TaskRunnableDecodeMethods;
...
class PhotoDownloadRunnable implements Runnable {
	...
	private static final String IMAGE_CACHE_FOLDER = Environment
			.getExternalStorageDirectory().getPath() + "/LazyUpload/Cache";
	...
	public void run() {
		...
		photoFileName = photoFileName + ".imagefile";
