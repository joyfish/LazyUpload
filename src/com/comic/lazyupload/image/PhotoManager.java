...
public class PhotoManager {
		...
		mHandler = new Handler(Looper.getMainLooper()) {
			...
			public void handleMessage(Message inputMessage) {
				...
				if (localView != null) {
					 ...
					 * ImageView.
					 */
					int downloadingImageId = localView
							.getCustomDownloadingImage();
	...
	public void handleState(PhotoTask photoTask, int state) {
		...
		case TASK_COMPLETE:
			...
			if (photoTask.isCacheEnabled()) {
				...
				mPhotoCache.put(photoTask.getImageURL(),
	...
	public static void cancelAll() {
		 ...
		 */
		PhotoTask[] taskArray = new PhotoTask[sInstance.mDownloadWorkQueue
				.size()];
	...
	static public PhotoTask startDownload(PhotoView imageView,
		 ...
		 */
		downloadTask.setByteBuffer(sInstance.mPhotoCache.get(downloadTask
				.getImageURL()));
